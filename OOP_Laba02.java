public class OOP_Laba01 {
    public static class Book {
        ...
        private int year;
        private static int odjcount = 0;
        // public Book(long id, String title, String author, int year){ Это без автоинкремента!!
        //     this.id = id;
        //     this.title = title;
        //     this.author = author;
        //     this.year = year;
    ...
    public static void main(String[] args) {
        Book firstbook = new Book("Война и мир", "Толстой Л.Н.", 1869);
        Book secondbook = new Book("Мастер и Маргарита", "Булгаков М.А.", 1967);
        Book thirdbook = new Book("Преступление и наказание", "Достоевский Ф.М.", 1866);
